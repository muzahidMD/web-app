        ...
        <footer className="footer footer-center p-10 'text-base-content' rounded bg-opacity-75 text-slate-300" style={{ backgroundImage: `url(${'https://i.ibb.co/9rt6z4J/bg-footer.jpg'})` }}>
            <div className='footer'>
                <div>
                    ...
                    <p> 5611 Wellington Road, Suite 115, Gainesville, VA 20155</p>
                </div>
                <div>
                    <h3 className='text-xl text-red-500 uppercase'>Services</h3>
                ...
                <div>
                    <h3 className='text-xl text-red-500 uppercase'>Company</h3>
                ...
                <div>
                    <h3 className='text-xl text-red-500 uppercase'>Legal</h3>
